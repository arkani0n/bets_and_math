...
class GrafMaker:
    ...
    def fill_heroes_rel_with_data(self):
        ...
        all_pages_buttons=self.driver.find_element_by_id('DataTables_Table_0_paginate').find_elements_by_tag_name('li')
    ...
    def graf_create_new(self,driver):
        driver.find_element_by_css_selector('.btn.btn-default.btn-sm.dropdown-toggle').click()
        driver.find_element_by_id('NewGraph').click()

    def graf_save(self,driver):
        driver.find_element_by_css_selector('.btn.btn-default.btn-sm.dropdown-toggle').click()
        driver.find_element_by_id('SaveGraph').click()
        graf_url=driver.find_element_by_id('GraphName').get_attribute('value')
        print(graf_url)
    ...
    def graf_input_heroes_rels(self,driver):
        driver.find_element_by_css_selector('.btn.btn-default.btn-sm.dropdown-toggle').click()
        driver.find_element_by_id('ShowAdjacencyMatrix').click()
        ...
        print('found box')
        driver.find_element_by_name('adjacencyMatrixField').send_keys(self.heroes_rel_to_str())
        print('input_done')
    ...
    def graf_change_names(self, driver):
        driver.find_element_by_css_selector('.btn.btn-default.btn-sm.dropdown-toggle').click()
        driver.find_element_by_id('GroupRename').click()
        driver.find_element_by_id('VertextTitleList').send_keys(self.heroes_dic_to_str())
        save_and_cancel_butt=driver.find_element_by_class_name('ui-dialog-buttonset').find_element_by_tag_name('button')
    ...
    def wight_vision_on(self):
        algorithms=self.driver.find_element_by_id('openAlgorithmList')
        algorithms.click()
        algorithms.find_element_by_id("OlegSh.ModernGraphStyle").click()
